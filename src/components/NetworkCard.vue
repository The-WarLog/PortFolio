<template>
  <div id="Network" class="window Network" role="dialog" aria-label="Gtihub window" :draggable="true"
    :style="{ left: position.x + 'px', top: position.y + 'px' }">
    <div class="title-bar" @mousedown="startDrag">
      <slot></slot>
      <div class="title-bar-text">Network</div>
    ...
    <div class="window-body">
      <h5>Connet With Me On My Linked In </h5> <span> <a class="link text-lg" target="_blank"
          href="https://www.linkedin.com/in/divyesh-gaygol-748983302/">
          https://www.linkedin.com/in/divyesh-gaygol-748983302/</a></span>


    </div>
    <div class="inside-buttons">
      <button class="default" @click="redirectToNetwork">OK</button>
...
function redirectToNetwork() {
  window.open('https://Network.com/The-WarLog', '_blank');
}
